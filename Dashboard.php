...
class Database {
    ...
    private $db_name = 'wedding_dashboard';
...
CREATE TABLE vendors (
    ...
    category ENUM('photographer', 'videographer', 'venue', 'catering', 'florist', 'decorator', 'musician', 'dj', 'makeup', 'dress', 'suit', 'transportation') NOT NULL,
    description TEXT,
...
CREATE TABLE user_vendors (
    ...
    status ENUM('interested', 'contacted', 'quoted', 'booked', 'cancelled') DEFAULT 'interested',
...
CREATE TABLE guests (
    ...
    email VARCHAR(150),
    phone VARCHAR(20),
    group_type ENUM('bride', 'groom', 'mutual') NOT NULL,
...
INSERT INTO vendors (name, category, description, price_range_min, price_range_max, rating, review_count, phone, email) VALUES
('Elena Rodriguez Photography', 'photographer', 'Award-winning wedding photographer specializing in romantic, candid moments', 2800, 4200, 4.9, 127, '555-0101', 'elena@rodriguezmemories.com'),
('Golden Hour Studios', 'photographer', 'Cinematic wedding films and photography duo', 3500, 6000, 4.8, 89, '555-0102', 'info@goldenhour.com'),
('Classic Moments Photo', 'photographer', 'Traditional and contemporary wedding photography', 2500, 4000, 4.9, 203, '555-0103', 'book@classicmoments.com'),
('Rosewood Manor', 'venue', 'Victorian mansion with gardens perfect for elegant weddings', 7500, 12000, 4.8, 156, '555-0201', 'events@rosewoodmanor.com'),
('Sunset Vineyard Estate', 'venue', 'Rustic elegance with panoramic vineyard views', 7200, 9800, 4.9, 98, '555-0202', 'weddings@sunsetvineyard.com'),
('Bella Vista Catering', 'catering', 'Farm-to-table cuisine with premium bar service', 65, 95, 4.9, 234, '555-0301', 'catering@bellavista.com'),
('Gourmet Expressions', 'catering', 'Contemporary cuisine with interactive food stations', 72, 95, 4.7, 187, '555-0302', 'events@gourmetexp.com'),
('Enchanted Blooms', 'florist', 'Luxury floral design with custom installations', 2400, 4800, 4.8, 145, '555-0401', 'design@enchantblooms.com'),
('Garden Party Designs', 'florist', 'Romantic garden-style arrangements and lighting', 1800, 3200, 4.9, 92, '555-0402', 'hello@gardenparty.com'),
('Bella Bridal Boutique', 'dress', 'Designer wedding gowns and accessories', 1200, 5000, 4.8, 178, '555-0501', 'appointments@bellabrides.com'),
('Glamour Studio by Maria', 'makeup', 'Bridal makeup and hair styling team', 650, 1200, 4.9, 167, '555-0601', 'maria@glamourstudio.com');
